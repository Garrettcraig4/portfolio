  ...
  render() {
    return (
      <div className="About">
        ...
        <p>
          when I was a teen i dual booted my pc with linux and windows and also
          I made my pc a (Hackintosh) where I installed the mac operating system
          on windows hardware then when I was 16 I built my own pc I picked out
          all the components and put it all together that was an amazing
          learning experience
        </p>
        <p>
